        ...
        <div class="property__wrapper">
          ...
          <div class="property__host">
            ...
            <div class="property__host-user user">
              <div
                class="property__avatar-wrapper property__avatar-wrapper--pro user__avatar-wrapper"
              >
                <img
            ...
            <div class="property__description">
              ...
              <p class="property__text">
                ...
                Opera, but where the bustle of the city comes to rest in this alley flowery
                and colorful.
              </p>
            </div>
          </div>
          <section class="property__reviews reviews">
            ...
            <form class="reviews__form form" action="#" method="post">
              ...
              <div class="reviews__rating-form form__rating">
                <input
                  class="form__rating-input visually-hidden"
                  name="rating"
                  value="5"
                  id="5-stars"
                  type="radio"
                ...
                <label
                  for="5-stars"
                  class="reviews__rating-label form__rating-label"
                  title="perfect"
                >
